...
def membuatprokom():
    ...
    Label(screen9, text="").pack()
    Button(screen9, text="Pertemuan 10", width="30", height="2", command=Pertemuan9).pack()
    Label(screen9, text="").pack()
    Button(screen9, text="Pertemuan 11", width="30", height="2", command=Pertemuan9).pack()
    Label(screen9, text="").pack()
    Button(screen9, text="Pertemuan 12", width="30", height="2", command=Pertemuan9).pack()
    Label(screen9, text="").pack()
    Button(screen9, text="Pertemuan 13", width="30", height="2", command=Pertemuan9).pack()
    Label(screen9, text="").pack()
    Button(screen9, text="Pertemuan 14", width="30", height="2", command=Pertemuan9).pack()
    Label(screen9, text="").pack()
    Button(screen9, text="Pertemuan 15", width="30", height="2", command=Pertemuan9).pack()
    Label(screen9, text="").pack()
    Button(screen9, text="Pertemuan 16", width="30", height="2", command=Pertemuan9).pack()
    Label(screen9, text="").pack()
